...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    ``with:`` statement.  A typical use of :class:`.EnvironmentContext`::
        ...
        config = Config()
        config.set_main_option("script_location", "myapp:migrations.backup")
    ...
    def is_offline_mode(self):
        """Return True if the current migrations.backup environment
    ...
    def configure(self,
        ...
        :param transaction_per_migration: if True, nest each migration script
         in a transaction rather than the full series of migrations.backup to
         run.
        ...
        :param render_as_batch: if True, commands which alter elements
         ...
         directive, so that batch migrations.backup will take place.
        ...
        :param mssql_batch_separator: The "batch separator" which will
         ...
         migrations.backup.  Defaults to ``GO``.  Note this is in addition to the
        ...
        :param oracle_batch_separator: The "batch separator" which will
         ...
         Oracle migrations.backup.  Defaults to ``/``.  Oracle doesn't add a
    ...
    def run_migrations(self, **kw):
        """Run migrations.backup as determined by the current command line
        configuration
