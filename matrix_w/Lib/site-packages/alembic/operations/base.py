...
class Operations(util.ModuleClsProxy):
    ...
    migrations.backup by passing in a :class:`.MigrationContext`::
    ...
    def batch_alter_table(
        ...
        """Invoke a series of per-table migrations.backup in batch.
        ...
        migrations.backup include operations not supported by SQLite's ALTER TABLE,
