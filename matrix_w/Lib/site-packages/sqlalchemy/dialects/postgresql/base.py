...
<http://www.postgresql.org/docs/current/statico/ddl-schemas.html#DDL-SCHEMAS-PATH>`_.
...
.. seealso::
        ...
        <http://www.postgresql.org/docs/9.0/statico/ddl-schemas.html#DDL-SCHEMAS-PATH>`_
...
.. seealso::
    ...
    `INSERT .. ON CONFLICT <http://www.postgresql.org/docs/current/statico/sql-insert.html#SQL-ON-CONFLICT>`_ - in the PostgreSQL documentation.
...
http://www.postgresql.org/docs/8.3/statico/indexes-types.html). These can be
...
.. seealso::
    ...
    <http://www.postgresql.org/docs/current/statico/sql-createtable.html>`_
